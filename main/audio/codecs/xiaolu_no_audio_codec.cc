#include "xiaolu_no_audio_codec.h"

#include <esp_log.h>
#include <cmath>
#include <cstring>

#define TAG "XiaoluNoAudioCodec"

XiaoluNoAudioCodecSimplexPdm::XiaoluNoAudioCodecSimplexPdm(int input_sample_rate, int output_sample_rate, 
...
int XiaoluNoAudioCodecSimplexPdm::Write(const int16_t* data, int samples) {
...
int XiaoluNoAudioCodecSimplexPdm::Read(int16_t* dest, int samples) {
    size_t bytes_read;
